...
def main():
	...
	parser.add_argument('-m', '--method', help='Corrector method to use.', action='append', default=[], choices=('pixvsmag', 'contam', 'mag2flux', 'stamp', 'noise', 'noise_compare', 'magdist', 'waittime'))
